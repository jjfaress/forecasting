...
#bert L12: https://tfhub.dev/tensorflow/bert_en_uncased_L-12_H-768_A-12/4
#bert L12 preprocess: https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/3
# bert small preprocess: https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/3
# bert small: https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-4_H-128_A-2/2
#bert L24: https://tfhub.dev/tensorflow/bert_en_uncased_L-24_H-1024_A-16/4
#bert L24 preprocess: https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/3
...
def build():
    ...
    # net = layers.Reshape((1, 128))(net)
    # cnn = layers.Conv1D(128, 1, input_shape=(1, 128))(net)
    # cnn = layers.MaxPooling1D(padding='same')(net)
    # # lstm = Bidirectional(layers.LSTM(32, return_sequences=True))(cnn)
    # lstm = Bidirectional(layers.LSTM(64))(net)
...
data = data.append(stanfordcsv[:125000], ignore_index=True)
